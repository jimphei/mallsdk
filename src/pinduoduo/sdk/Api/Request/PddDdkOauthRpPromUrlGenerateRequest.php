...
class PddDdkOauthRpPromUrlGenerateRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(\Com\Pdd\Pop\Sdk\Api\Request\PddDdkOauthRpPromUrlGenerateRequest_DiyOneYuanParam, "diy_one_yuan_param")
	*/
...
class PddDdkOauthRpPromUrlGenerateRequest_DiyOneYuanParam extends PopBaseJsonEntity
{
